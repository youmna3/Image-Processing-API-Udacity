...
var sharpResize = function (name, heightString, weidthString) { return __awaiter(void 0, void 0, void 0, function () {
    var buffer, image, resizedimage;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                buffer = "assets/".concat(name, ".jpg");
                return [4 /*yield*/, (0, sharp_1.default)(buffer)];
            case 1:
                image = _a.sent();
                return [4 /*yield*/, image.resize(weidthString, heightString)];
            case 2:
