...
var image_resize_1 = __importDefault(require("../../utilities/image-resize"));
...
imageRoutes.get('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var name, width, height, imgPath, folderPath, thumb, result, imgs;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                imgPath = path_1.default.resolve('./assets') + "/".concat(name, ".jpg");
                folderPath = path_1.default.resolve('./assets') + "/thumb";
                thumb = "".concat(folderPath, "/").concat(name, "x").concat(width, "x").concat(height, ".jpg");
                //make the new folder for resized images
                if (!fs_1.default.existsSync(folderPath))
                    fs_1.default.mkdirSync(folderPath);
                if (fs_1.default.existsSync(thumb))
                    return [2 /*return*/, res.sendFile(thumb)];
                return [4 /*yield*/, (0, image_resize_1.default)(imgPath, width, height, thumb)];
            case 1:
                result = _a.sent();
                if (result === true)
                    res.sendFile(thumb);
                ...
                imgs = data_1.default.includes(name);
                if (imgs === false) {
